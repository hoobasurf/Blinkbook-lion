...
// Boutons
document.getElementById("photoBtn").addEventListener("click", () => alert("📸 Fonction photo à venir !"));
document.getElementById("fileBtn").addEventListener("click", () => alert("🖼️ Import image à venir !"));
